...
public class Wrapper {
	...
	static String wrap(String input, int columnNumber) {
		...
		//determine whether line breaks are needed with if statement
		if (input.length() > columnNumber) {
			//check for whitespace traversing string backwards from an index that is based on # of columns and index of
			//last line break
